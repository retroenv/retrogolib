...
type paramReaderFunc func(c *CPU, resolveIndirect bool) ([]any, []byte, bool)
...
func readOpParams(c *CPU, addressing Mode, resolveIndirect bool) ([]any, []byte, bool) {
	...
	params, opcodes, pageCrossed := fun(c, resolveIndirect)
...
func paramReaderImmediate(c *CPU, _ bool) ([]any, []byte, bool) {
...
func paramReaderAbsolute(c *CPU, _ bool) ([]any, []byte, bool) {
...
func paramReaderAbsoluteX(c *CPU, _ bool) ([]any, []byte, bool) {
	b1 := uint16(c.memory.Read(c.PC + 1))
	b2 := uint16(c.memory.Read(c.PC + 2))
	w := b2<<8 | b1
...
func paramReaderAbsoluteY(c *CPU, _ bool) ([]any, []byte, bool) {
	b1 := uint16(c.memory.Read(c.PC + 1))
	b2 := uint16(c.memory.Read(c.PC + 2))
	w := b2<<8 | b1
...
func paramReaderZeroPage(c *CPU, _ bool) ([]any, []byte, bool) {
	b := c.memory.Read(c.PC + 1)
...
func paramReaderRelative(c *CPU, _ bool) ([]any, []byte, bool) {
...
func paramReaderIndirect(c *CPU, _ bool) ([]any, []byte, bool) {
...
func paramReaderIndirectX(c *CPU, resolveIndirect bool) ([]any, []byte, bool) {
	b := c.memory.Read(c.PC + 1)
	offset := uint16(b + c.X)
...
func paramReaderIndirectY(c *CPU, resolveIndirect bool) ([]any, []byte, bool) {
	b := c.memory.Read(c.PC + 1)
